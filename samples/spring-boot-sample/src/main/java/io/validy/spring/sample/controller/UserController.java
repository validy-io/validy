package io.validy.spring.sample.controller;
...
import io.validy.spring.sample.service.UserService;
import io.validy.spring.sample.service.ValidationException;
 ...
 *
 * 1. @Validated on @RequestBody  — Spring MVC calls ValidyValidator automatically,
...
public class UserController {
    ...
    // ── @Validated approach — Spring calls Validy automatically ───────────────

    /**
     * POST /users
     *
     * @Validated triggers ValidyValidator before the method body runs.
