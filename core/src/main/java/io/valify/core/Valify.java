...
import io.valify.core.rules.CollectionRules;
import io.valify.core.rules.NumberRules;
import io.valify.core.rules.StringRules;

import java.util.Collection;
import java.util.function.Predicate;

/**
 * Central façade — a single {@code import static io.valify.core.Valify.*} gives access
 * to the entire DSL.
 *
 * <h2>Quick-start</h2>
 * <pre>{@code
